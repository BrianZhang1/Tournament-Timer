(function () {
    // Enclosing everything so that if this is used as code for another program, then global variables wont affect other code.
    ...
    function initialize() {
        ...
        document
            .getElementById("brightnessIcon")
            .addEventListener("click", toggleBrightness);
        document
            .getElementById("brightnessIconBackground")
            .addEventListener("click", toggleBrightness);
        document
            .getElementById("soundIconBackground")
            .addEventListener("click", toggleSound);
        document
            .getElementById("soundIcon")
            .addEventListener("click", toggleSound);
        document
            .getElementById("customTimeInputButton")
            .addEventListener("click", setCustomTime);
        document
            .getElementById("showInputBox")
            .addEventListener("click", showInputBox);
        document
            .getElementById("stagePrevious")
            .addEventListener("click", previousStep);
        document
            .getElementById("stageNext")
            .addEventListener("click", nextStep);
        document
            .getElementById("togglePause")
            .addEventListener("click", startTimer);
        document
            .getElementById("resetSelect")
    ...
    function calculateTime() {
        ...
        if (overtimeState) {
            if (timeLeft == -1) {
                document.getElementById("overtimeId").style.visibility =
                    "visible";
    ...
    function showTime() {
        ...
        if (overtimeState) {
            var minutesLeft = Math.abs(Math.ceil(timeLeft / 60));
        }
        var secondsLeft = Math.abs(timeLeft % 60);
        var timeShown =
            zeroMinutes + minutesLeft + ":" + zeroSeconds + secondsLeft;
    ...
    function reset(mode) {
        switch (mode) {
            ...
            case "Select":
                document.getElementById("resetSelect").style.visibility =
                    "hidden";
                document.getElementById("resetTimer").style.visibility =
                    "visible";
                document.getElementById("resetStage").style.visibility =
                    "visible";
                document.getElementById("resetBack").style.visibility =
                    "visible";
            ...
            case "Reset":
                ...
                document.getElementById("togglePause").className =
                    "startButton";
                document
                    .getElementById("togglePause")
                    .removeEventListener("click", pause);
    ...
    function showInputBox() {
        ...
        var inputVisibility = window.getComputedStyle(
    ...
    function setCustomTime() {
        ...
        document.getElementById("customTimeInputButton").style.visibility =
            "hidden";
        document.getElementById("customTimeInputText").style.visibility =
            "hidden";
        if (stage != "Custom") {
            oldStage = stage;
        }
    ...
    function toggleBrightness() {
        if (brightnessMode == false) {
            ...
            document.getElementById("brightnessIcon").src =
                "photos/lightBulbOn.png";
            document.getElementById("brightnessIcon").title =
                "Changes the screen to dark mode";
            ...
            document.getElementById("brightnessIcon").src =
                "photos/lightBulbOff.png";
            document.getElementById("brightnessIcon").title =
                "Changes the screen to light mode";
